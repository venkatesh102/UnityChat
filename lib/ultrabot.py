...
class ultraChatBot():    
    def __init__(self, json):
        ...
        self.ultraAPIUrl = 'https://api.ultramsg.com/instance62903/'
        self.token = 'r9v6jom860d3pdy1'
...
#         return self.send_message(chatID, welcome_string)
    ...
    def chat_bot(self, chatID,text):
        ...
        print(runtime)
        if langid=='en':
            return self.send_message(chatID,reply)
        return self.send_message(chatID, translate_text(reply,'en',langid))
            ...
            if not message['fromMe']:
                ...
                if text[0].lower() == '':
                    ...
                    for n in text:
                        s = s + n + " "
                    global langid 
                    langid=detect_language(s)   
                    if langid=='en':
                        return self.chat_bot(chatID,s)
                    else:
                        return self.chat_bot(chatID, translate_text(s,langid,'en'))
